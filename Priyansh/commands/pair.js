...
module.exports.run = async function ({ args, Users, Threads, api, event, Currencies }) {
  ...
  var background = [
   "https://i.postimg.cc/Hncn7FzP/Picsart-24-07-14-02-01-33-567.jpg",
    ...
    "https://i.postimg.cc/cHJczGGp/resize-17412682691649690599-Picsart250306190559006.jpg"
 ];
...
💞 »»
『
   🥲┼┼──🦋 𝐊ɪɴ 𝐋ᴀғᴢᴏɴ 𝐌ᴇ 𝐁ʏᴀɴ 𝐊ᴀʀᴜ      🥲┼┼──🍁                         𝐀ʜᴇᴍɪʏᴀᴛ 𝐓ᴇʀɪ  🥲┼┼──🦋°          𝐊ɪ 𝐁ɪɴ 𝐓ᴇʀᴇ 𝐍ᴀᴍᴜᴍᴋɪɴ 𝐒ɪ 𝐋ᴀɢᴛɪ 𝐇ᴀ𝐢•||•●┼ᚐ🩵 ꯭←̟̽ __  ꯭←̟̽🩷💋┼──                                🥲┼┼──°   𝐙ɪɴᴅᴀɢɪ 𝐌ᴇʀɪ  』
  
  ${name1} 
       🥺◀🅛🅞🅥🅔🅢▶🥺
  ${name2}\n
  𝓐𝒑𝒑 𝓓𝒐𝒏𝒐 𝓚𝒆 𝓖𝒖𝒏 💌 ${tile}%
